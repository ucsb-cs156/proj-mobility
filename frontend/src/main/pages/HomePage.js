...
export default function HomePage() {
  return (
    <BasicLayout>
      <div className="pt-2">
      <h1 data-testid= "welcome-header" style = {{ padding: "20px"}}>Welcome to <b data-testid = "UCSB" style = {{backgroundColor:"#003660", padding: "0px 10px"}}> <font data-testid = "white" color = "#FFFFFF"  >UCSB</font></b> mobility!</h1>
